    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <Image source={require('./image/logo512.jpg')} style={{width:250, height:250}}>
                    <View
                        style={{width:250,alignItems:'center',backgroundColor:'transparent',position:'absolute',marginTop: 190,}}>
                        <Text style={{color:'white',fontFamily:'BMJUA',fontSize:28}}>윈드피커</Text>
                    </View>
                </Image>
                ...
                <TouchableOpacity onPress={() => this.props.setModeChange('surf')}>
                    <View
                        style={[styles.menuView, {backgroundColor: this.props.viewMode == 'surf' ? '#E0E0E0' : null  }]}>
                ...
                <TouchableOpacity onPress={() => this.props.setModeChange('gliding')}>
                    <View
                        style={[styles.menuView, { backgroundColor: this.props.viewMode == 'gliding' ? '#E0E0E0' : null  }]}>
